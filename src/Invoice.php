...
class Invoice
{
     ...
     * With this method, you can add an invoice to the merchant to charge for
     * your services You can only add invoices to merchants, if you set the
     * settleBalance to true when adding the merchant
     *
     * Options array
     * Required
     * merchantId - The merchant id of the merchant you want to create the
     * invoice for invoiceId - Your invoiceId amount - The total amount of the
     * invoice description - The description of the invoice
     *
     * Optional
     * invoiceUrl - The url to the invoice, the merchant can use this to
     * download the invoice makeYesterday - Use this to create the invoice
     * yesterday 23:59:59
     *
     * @param array $options See above
     *
     * @return array|Result\Invoice\Add
     * @throws Required
     */
