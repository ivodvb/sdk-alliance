...
class AddService extends Api
{
    ...
    /**
     * @var int the Category of the service use
     *      Paynl\Alliance\Service::getCategories to get a list
     */
    private $_categoryId;
    /**
    ...
    /**
     * @var bool Set to false to only receive an exchange call for paid
     *      transactions (not cancel, pending, refund etc.)
     */
